...
const INTENT_PATTERNS: IntentPattern[] = [
  ...
  },
  {
    ...
    patterns: [/portfolio/i, /exposure/i, /NPL/i, /watch\s*list/i],
    keywords: ["portfolio", "exposure", "npl", "concentration", "provision"],
  },
  {
    agent: "regulatory_compliance",
    domain: "compliance",
    intent: "compliance_check",
    patterns: [/compliance/i, /QCB/i, /PDPPL/i, /regulation/i, /sharia/i],
    keywords: ["compliance", "regulation", "qcb", "pdppl", "sharia", "audit"],
  },
  {
